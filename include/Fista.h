...
//cerr<<"z i nx ny nl nc "<<i<<":"<<z.nx()<<","<<z.ny()<<","<<z.nl()<<","<<z.nc()<<endl;
	...
	// Save current solution
        ...
        //if(i!=0)Domain->adjoint_recons(xtmp,z);  // MOD JG MARCH 2014
...
//cerr<<"z i nx ny nl nc "<<i<<":"<<z.nx()<<","<<z.ny()<<","<<z.nl()<<","<<z.nc()<<endl;
	...
	//Domain->recons(x,z);
        Domain->adjoint_recons(x,z); // MOD JG March 2014
...
//cerr<<"zreal nx ny nl nc "<<zreal.nx()<<","<<zreal.ny()<<","<<zreal.nl()<<","<<zreal.nc()<<endl;
	...
	//Domain->recons(x,zreal);
        Domain->adjoint_recons(x,zreal); // JG MARCH 2014
